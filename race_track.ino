// Black Line Follower 
int IR1=1;      //Right sensor
int IR2=12;    //left Sensor
// motor one
...
void loop() 
{
   if(digitalRead(IR1)==HIGH && digitalRead(IR2)==HIGH) // car will not move 
  {
    //Stop both Motors
  ...
  else if(digitalRead(IR1)==LOW && digitalRead(IR2)==LOW)  //car will follow black line
